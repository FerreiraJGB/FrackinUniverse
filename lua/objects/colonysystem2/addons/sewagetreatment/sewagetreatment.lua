...
function wellInit()
	...
	wellsDrawing=1+#(world.entityQuery(entity.position(),wellRange,{includedTypes={"object"},withoutEntityId = entity.id(),callScript="fu_isAddonSewageTreatment"}) or {})
end

function fu_isAddonSewageTreatment() return true end
