...
function wellInit()
	...
	wellsDrawing=1+#(world.entityQuery(entity.position(),wellRange,{includedTypes={"object"},withoutEntityId = entity.id(),callScript="fu_isAddonSubliminal"}) or {})
end

function fu_isAddonSubliminal() return true end
