							...
							if not self.colorCache[sType][cacheKey] then
								if sType == "cave" then
									if world.pointTileCollision(position) then
										self.colorCache[sType][cacheKey] = scannerLib.colors.solid
									else
										self.colorCache[sType][cacheKey] = scannerLib.colors.empty
									end
								elseif sType == "ore" then
									...
									if scannerLib.colors[oreMod] then
										self.colorCache[sType][cacheKey] = scannerLib.colors[oreMod]
									else
										self.colorCache[sType][cacheKey] = scannerLib.colors.none
									end
								end
							end
						end
