...
function interact(args)
  local monsterChatOptions = config.getParameter("monsterChatOptions", {})
  if #monsterChatOptions > 0 then
    monster.say(monsterChatOptions[math.random(1, #monsterChatOptions)])
  end
end
