...
function init()
  ...
  local targetOre = config.getParameter("currentTargetOre")
  activeItem.setScriptedAnimationParameter("currentTargetOre",targetOre)
  local targetOreColor = config.getParameter("targetOreColor")
  activeItem.setScriptedAnimationParameter("targetOreColor",targetOreColor)
  local nonTargetOreColor = config.getParameter("nonTargetOreColor")
  activeItem.setScriptedAnimationParameter("nonTargetOreColor",nonTargetOreColor)
end
